...
public class serviceProposition  implements  IService <Proposition>{
    ...
    public void ajouter(Proposition prop) {
        ...
        String req = "INSERT INTO `proposition` (`id`, `description`, `objet`, `idConsomateur`) VALUES (NULL, ?, ?, ?)";
    ...
    public List<Proposition> chercher(String searchTerm) {
        List<Proposition> propositions = new ArrayList<>();
        String sql = "SELECT * FROM proposition WHERE description LIKE ? OR objet LIKE ?";
